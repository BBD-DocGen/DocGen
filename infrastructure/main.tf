...
resource "aws_security_group" "docgen-instance-sg" {
  name        = "webserver_sg"
...
resource "aws_db_instance" "docgen-rds" {
...
resource "aws_elastic_beanstalk_application" "docgen-beanstalk-app" {
  name        = "docgen-application"
  description = "docgen application for documentation generation"
}
...
resource "aws_elastic_beanstalk_environment" "docgen-elastic-beanstalk-env" {
  ...
  setting {
    ...
    name      = "SecurityGroups"
    value     = aws_security_group.docgen-instance-sg.id
  }
